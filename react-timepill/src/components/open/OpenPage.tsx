import { IPill } from "../../../task-timepill/src/types"
  ...
  render() {
    ...
    if(this.state.pill) {
      ...
      switch(this.state.flag) {
        case 1: component = <NoSUchKey />; break;
        case 2: component = <OpenTip time={time} name={name} tip={tip} key={key} />; break;
        case 3: component = <OpenInfo time={time} name={name} info={info} key={key} />; break;
        default: component = '' ;
      }
    } else {
      switch(this.state.flag) {
        ...
        <div className="open-main">
          <div className="open">
            ...
            <div className="open-input">
              ...
              <input type="text" name="key" value={ this.state.input } id="key" onChange={this.handleInputChange} />
              <div className="submit-btn" onClick={this.handleClick}>打开胶囊</div>
            </div>
          </div>
          {
            component
