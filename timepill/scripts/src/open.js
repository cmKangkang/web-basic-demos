...
function init() {
    let keyNode = document.querySelector('#key') || null;
    let submitBtn = document.querySelector('.submit-btn') || null;
    let noKeyNode = document.querySelector('.no-such-key') || null;
    submitBtn.addEventListener('click', () => {
        ...
        let pills = JSON.parse(localStorage.getItem('timepills'));
 ...
 */
function showContent(name, time, info) {
    let openNode = document.querySelector('.open') || null, contentNode = document.querySelector('.open-content') || null;
    openNode.style.display = 'none';
    contentNode.style.display = 'block';
    let pillLabel = contentNode.querySelector('.pill-label') || null, pillContent = contentNode.querySelector('.pill-content') || null;
 ...
 * @param tip 提示信息
 */
function showTip(name, time, tip) {
    let tipNode = document.querySelector('.open-tip') || null;
    let openNode = document.querySelector('.open') || null;
    openNode.style.display = 'none';
    tipNode.style.display = 'block';
    let date = stringToDate(time);
    let tips = tipNode.querySelector('.tips') || null, pillContent = tipNode.querySelector('.pill-content') || null;
